...
def EDR_df_to_intermediate_csv(EDR_df: pd.DataFrame, output_csv_path: str):
    """
    ...
    Args:
    - EDR_df (pd.Dataframe): Dataframe created from EDR logs.
    ...
    df_filtered = EDR_df[['causality_actor_process_image_path', 'action_remote_ip', 'action_remote_port', 'dst_action_external_hostname']]
...
def process_sv_file(input_sv_file_path: str, output_csv_path: str) -> None:
    ...
    EDR_df_to_intermediate_csv(df, output_csv_path)
